      ...
      <div className="main-container wrapper flex items-center flex-col gap-10">
        ...
        <form action="" className="flex flex-col gap-3">
          <div className="flex flex-col gap-2">
            ...
            <input
              className="border-1 py-2 px-5 border-gray-400 rounded-3xl w-[320px]"
              type="text"
              id="fullName"
              value={name}
              onChange={handleName}
          ...
          <button
            className="bg-green-700 text-white py-1 px-3 rounded-2xl font-medium hover:bg-green-800 w-fit my-5 text-[18px]"
            type="submit"
